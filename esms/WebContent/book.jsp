	  ...
	  $.ajax({
		  ...
		  success:function(datas){
			  for(var i=0;i<datas.length;i++){
				  ...
				  var divStr  = 
					  " <div class='item'>"
	                  +"<h3><b>&gt;</b><a href='bookList.do?parent_id="+obj.category_id+"' class='dot'>"+obj.name+"</a></h3>"
	                  +"</div>"
	              $(".sort_list").append($(divStr));    
			  }
		  },
		  dataType:"json"
	  });
...
<div class="main page_width">
	...
	<div id="left">
    	<div id="book_sort">
            ...
            <div class="sort_list">
                ...
                <div class='item'>
                	<h3><b>&gt;</b><a href='bookList.do?parent_id=${category.category_id}' class="dot">${category.name}</a></h3>
                </div>
                </c:forEach>
            </div>          
        </div>
    ...
    <div id="right">
    	<div class="" id="report">
			...
			<div class="book_content">
				<ul >
                     <c:forEach  items="${bookNews}" var="news">                     
