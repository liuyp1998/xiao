    ...
    <div id="login">
        ...
        <div class="login_form">
			...
			<form id="login_form" action="login.do" method="post">
             	<div class="form_info">
                	<div class="label">用户名：
                	</div><input type="text"  name="login_name" class="text"/>
                </div>
             	<div class="form_info">
                	<div class="label">密码：
                	</div><input type="password" name="password" class="text"/>
                </div>
                <div class="form_info">
                	<div class="label">&nbsp;</div>
                ...
                <div class="form_info">
                	<div class="label">&nbsp;</div>
                	<a href="javascript:"><img id="login_btn" src="images/login.jpeg" 
                	onclick="login()"/></a> <span>${msg}</span>
                </div>
                <div class="cor_web">
                    使用合作网站账号登录京东：<br />
