...
public class XdlProduct {
	...
	public XdlProduct(int product_id, String name, Timestamp add_time, String picture, String big_picture,
	...
	public XdlProduct(int product_id, String name, String keywords, Timestamp add_time, String picture,
